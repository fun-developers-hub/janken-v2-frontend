        ...
        tabs={[
          {
            ...
            content: (
              <div className="flex flex-col gap-3 text-sm leading-relaxed">
                <p>
                  <code>next/font/google</code> はGoogle
                  Fontsをビルド時にダウンロードし、
                  自分のドメインからセルフホストする仕組み。
                  ブラウザが外部のフォントサーバーへリクエストしないため、
                  読み込み待ちによるレイアウトのガタつき（CLS）を防げる。
                </p>
                <p>
                  このプロジェクトでは <code>src/app/layout.tsx</code> で{" "}
                  <code>Geist</code> と <code>Geist_Mono</code>{" "}
                  を読み込み、それぞれ <code>--font-geist-sans</code> /{" "}
                  <code>--font-geist-mono</code> というCSS変数として
